! function (t) {
    ...
    function a(t) {
        ...
        var t = document.getElementsByClassName("wp-calculator-bruto-neto-canvas");
        for (var e in t)
            if (t.hasOwnProperty(e)) {
                var r = t[e];
                n(r.getAttribute("data-country"), r.getAttribute("data-language"))
            }
        function n(t, e) {
        ...
        function i() {
            return (i = a(o.a.mark((function t(e, r) {
                var n, i;
                return o.a.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return t.next = 2, fetch("https://corona.lmao.ninja/v2/historical/" + e);
                        case 2:
                            return n = t.sent, t.next = 5, n.json();
                        case 5:
                            return c(i = t.sent, e, r), t.abrupt("return", i);
                        case 8:
                        case "end":
                            return t.stop()
                    }
        ...
        function c(t, e, r) {
            var n = function (t) {
                ...
                o = Object.keys(t.timeline.cases),
                i = Object.values(t.timeline.cases),
                a = Object.values(t.timeline.deaths),
                c = {
                    type: "line",
                    data: {
                        labels: o,
                ...
                u = document.getElementById(e).getContext("2d");
            new Chart(u, c)
        }
    }()
}, function (t, e, r) {
